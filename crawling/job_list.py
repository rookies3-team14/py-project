...
# ENTIRE_STACK_LIST = []
# stack_lists = [FRONT_STACK_LIST,BACK_STACK_LIST,IOS_STACK_LIST,  CROSS_STACK_LIST, ANDROID_STACK_LIST, GAME_STACK_LIST, SECURITY_STACK_LIST, CLOUD_STACK_LIST]
...
#         get_entire_stack_list(stack_list)
#     return ENTIRE_STACK_LIST
